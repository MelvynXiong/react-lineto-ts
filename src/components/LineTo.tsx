...
import { LineToProps, Delay } from '../interface';
import { Line } from '..';
...
export default class LineTo extends Component<LineToProps> {
  ...
  detect() {
    ...
    if (within) {
      ...
      offsetX -=
        boxp.left + (window.pageXOffset || document.documentElement.scrollLeft) - p.scrollLeft;
      offsetY -=
        boxp.top + (window.pageYOffset || document.documentElement.scrollTop) - p.scrollTop;
    }
